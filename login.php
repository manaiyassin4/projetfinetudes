...
<div class="signup-form">
    <form action="login.inc.php" method="post" class="form-horizontal">
      	<div class="row">
        ...
        <div class="form-group row">
			<label class="col-form-label col-4">Login</label>
			<div class="col-8">
		...
		<div class="form-group row">
			...
			<div class="text-center"> <a href="probleme.php">Signalez un probléme ?</a></div>
		</div>		      
    </form>
